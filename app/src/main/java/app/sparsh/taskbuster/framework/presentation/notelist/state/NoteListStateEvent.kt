package app.sparsh.taskbuster.framework.presentation.notelist.state

import app.sparsh.taskbuster.business.domain.model.Note
import app.sparsh.taskbuster.business.domain.state.StateEvent
import app.sparsh.taskbuster.business.domain.state.StateMessage
